...
public class PistolBulletEntity extends AbstractBullet {
    ...
    public PistolBulletEntity(EntityType<? extends PistolBulletEntity> p_36858_, Level p_36859_) {
        super(p_36858_, p_36859_);
    }

    public PistolBulletEntity(Level p_36861_, double p_36862_, double p_36863_, double p_36864_) {
        super(EntityType.ARROW, p_36862_, p_36863_, p_36864_, p_36861_);
    }

    public PistolBulletEntity(Level p_36866_, LivingEntity p_36867_) {
