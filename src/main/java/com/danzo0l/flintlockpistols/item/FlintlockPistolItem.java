...
import com.danzo0l.flintlockpistols.sound.SoundMod;
...
import static com.danzo0l.flintlockpistols.item.ItemMod.PISTOL_BULLET;
import static com.danzo0l.flintlockpistols.tag.TagMod.Items.BULLETS;

public class FlintlockPistolItem extends ProjectileWeaponItem implements Vanishable {
    ...
    private static final float BULLET_POWER = 3.45F;

    public FlintlockPistolItem(Item.Properties properties) {
        super(properties);
    }

    public static final Predicate<ItemStack> BULLET_ONLY = (p_43017_) -> p_43017_.is(BULLETS);
    ...
    public void releaseUsing(@NotNull ItemStack p_40875_, @NotNull Level p_40876_, @NotNull LivingEntity p_40877_, int p_40878_) {
        int i = this.getUseDuration(p_40875_) - p_40878_;
        float f = getPowerForTime(i, p_40875_);
        if (EnchantmentHelper.getItemEnchantmentLevel(Enchantments.FLAMING_ARROWS, p_40875_) > 0) {
//            abstractarrow.setSecondsOnFire(100);
        ...
        if (f >= 1.0F && !isCharged(p_40875_) && tryLoadProjectiles(p_40877_, p_40875_)) {
            ...
            p_40876_.playSound((Player)null, p_40877_.getX(), p_40877_.getY(), p_40877_.getZ(), SoundMod.PISTOL_RELOAD_SOUND.get(), soundsource, 1.0F, 1.0F / (p_40876_.getRandom().nextFloat() * MID_SOUND_PERCENT + 1.0F) + START_SOUND_PERCENT);
        }
    }
    ...
    private static boolean loadProjectile(LivingEntity p_40863_, ItemStack p_40864_, ItemStack p_40865_, boolean p_40866_, boolean p_40867_) {
        if (p_40865_.isEmpty()) {
            ...
            boolean flag = p_40867_ && p_40865_.getItem() instanceof PistolBulletItem;
            ItemStack itemstack;
    ...
    private static void shootProjectile(Level p_40895_, LivingEntity p_40896_, InteractionHand p_40897_, ItemStack p_40898_, ItemStack p_40899_, float p_40900_, boolean p_40901_, float p_40902_, float p_40903_, float p_40904_) {
        if (!p_40895_.isClientSide) {
            boolean flag = !p_40899_.is(Items.ARROW);
            ...
            p_40895_.playSound((Player)null, p_40896_.getX(), p_40896_.getY(), p_40896_.getZ(), SoundMod.PISTOL_SHOOT_SOUND.get(), SoundSource.PLAYERS, 1.0F, p_40900_);
        }
    }
    ...
    public void onUseTick(Level p_40910_, @NotNull LivingEntity p_40911_, @NotNull ItemStack p_40912_, int p_40913_) {
        if (!p_40910_.isClientSide) {
            int i = EnchantmentHelper.getTagEnchantmentLevel(Enchantments.QUICK_CHARGE, p_40912_);
            SoundEvent soundevent = SoundMod.PISTOL_RELOAD_0_SOUND.get();
            SoundEvent soundevent1 = i == 0 ? SoundMod.PISTOL_RELOAD_1_SOUND.get() : null;
    ...
    public int getUseDuration(@NotNull ItemStack p_40938_) {
    ...
    public static int getChargeDuration(ItemStack p_40940_) {
        ...
        return i == 0 ? MAX_CHARGE_DURATION : MAX_CHARGE_DURATION - 4 * i;
    }
    ...
    public void appendHoverText(@NotNull ItemStack p_40880_, @Nullable Level p_40881_, @NotNull List<Component> p_40882_, @NotNull TooltipFlag p_40883_) {
